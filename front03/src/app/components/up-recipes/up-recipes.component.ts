...
@Component({
  selector: 'app-up-recipes',
  templateUrl: './up-recipes.component.html',
  styleUrls: ['./up-recipes.component.css'],
...
export class RecipesComponent implements AfterViewInit {
  ...
  public editorData: string = `
        ...
        <h2>Instructions</h2>
        <ol>
          <li>Combine cream, milk, sugar, and salt. Whisk until the sugar dissolves.</li>
          <li>Add vanilla extract and stir well.</li>
          <li>Pour into an ice cream maker or freeze and stir every 30 minutes.</li>
        </ol>
        <figure>
            <p>Add img here</p>
          <figcaption>Step 1: Combine ingredients in a mixing bowl.</figcaption>
        </figure>
        <figure>
            <p>Add img here</p>
          <figcaption>Step 2: Combine ingredients in a mixing bowl.</figcaption>
        </figure>
        <figure>
            <p>Add img here</p>
          <figcaption>Step 3: Combine ingredients in a mixing bowl.</figcaption>
        </figure>
        <figure>
            <p>Add img here</p>
          <figcaption>Step 4: Combine ingredients in a mixing bowl.</figcaption>
        </figure>
